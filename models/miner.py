...
class ConvNeXt(nn.Module):
    def __init__(self, in_chans=3, num_classes=1000,
                 depths=None, dims=None, M=16, drop_path_rate=0.2,
...
def convnext_base(pretrained=False, M=16, in_22k=False, **kwargs):
    ...
    if pretrained:
        ...
        # wjl 只加载模型权重
        weights = torch.load('/media/wjl/Dpan/wyp/Fire_work/RS/EFM-Net/result/USTC_SmokeRS_01-28-19-14-47/checkpoint-best.pth', map_location=torch.device('cpu'))['model']
